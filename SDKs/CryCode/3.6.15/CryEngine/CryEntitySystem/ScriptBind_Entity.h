...
protected:
	...
	//! <code>Entity.LoadLightShape( slot, sLightShapeFile)</code>
	//! <description>Loads CGF geometry into the entity slot.</description>
	//!		<param name="slot">Slot identifier.</param>
	//!		<param name="sLightShapeFile">name of the light shape path to load</param>
	//!		<param name="nLSFlags">flags of the light shape</param>
	int LoadLightShape( IFunctionHandler* pH, int slot, const char * sLightShapeFile, const uint32 nLSFlags);
	...
	//! <code>Entity.GetAllAuxAudioProxiesID( hTriggerID )</code>
	//! <description>
	...
	//! <code>Entity.GetDefaultAuxAudioProxyID( hTriggerID )</code>
	//! <description>
	...
	//! <code>Entity.CreateAuxAudioProxy( hTriggerID )</code>
	//! <description>
	...
	//! <code>Entity.RemoveAuxAudioProxy( hTriggerID )</code>
	//! <description>
	...
	//! <code>Entity.ExecuteAudioTrigger( hTriggerID )</code>
	//! <description>
	...
	//! <code>Entity.StopAudioTrigger( hTriggerID )</code>
	...
	////////////////////////////////////////////////////////////////////////
	//! <code>Entity.SetAudioSwitchState( hSwitchID, hSwitchStateID )</code>
	...
	////////////////////////////////////////////////////////////////////////
	//! <code>Entity.SetAudioObstructionCalcType( nObstructionCalcType )</code>
	...
	//! <code>Entity.SetAudioProxyOffset( vOffset )</code>
	...
	//! <code>Entity.SetAudioRtpcValue( hRtpcID, fValue )</code>
...
private: // -------------------------------------------------------------------------------
	...
	bool ParseLightParams(IScriptTable *pLightTable, CDLight &light, bool* pIsCheapLight = 0);
