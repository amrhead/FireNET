...
CFirstPersonHandIKContext::SParams::SParams(IDefaultSkeleton& rIDefaultSkeleton)
{
...
void CFirstPersonHandIKContext::Update(float timePassed)
{
	...
	m_pCharacterInstance->GetISkeletonAnim()->PushPoseModifier(15, cryinterface_cast<IAnimationPoseModifier>(m_pPoseModifier), "FirstPersonHandIKContext");
