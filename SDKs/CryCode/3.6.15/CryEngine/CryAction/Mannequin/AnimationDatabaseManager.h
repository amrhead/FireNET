...
public:
	...
	bool RegisterTagDef(CTagDefinition *tagDefinition);
	...
	bool ApplyTagDefChanges(const CTagDefinition* pOriginal, CTagDefinition* pModified);
...
private:
	...
	void ProceduralToXML(XmlNodeRef outNode, const SProceduralEntry &procedural) const;
	bool XMLToProcedural(SProceduralEntry &procedural, XmlNodeRef root) const;
	...
	void SaveDatabase(IMannequinWriter *pWriter, CAnimationDatabase *pAnimationDatabase) const;
	void SaveControllerDef(IMannequinWriter *pWriter, SControllerDef *pControllerDef) const;
	void SaveTagDefinition(IMannequinWriter *pWriter, CTagDefinition *pTagDefinition) const;
