...
void CLipSyncProvider_FacialInstance::RequestLipSync(IEntityAudioProxy* pProxy, const TAudioControlID nAudioTriggerId, const ELipSyncMethod lipSyncMethod)
{
...
void CLipSyncProvider_FacialInstance::StartLipSync(IEntityAudioProxy* pProxy, const TAudioControlID nAudioTriggerId, const ELipSyncMethod lipSyncMethod)
{
...
void CLipSyncProvider_FacialInstance::PauseLipSync(IEntityAudioProxy* pProxy, const TAudioControlID nAudioTriggerId, const ELipSyncMethod lipSyncMethod)
{
	if (lipSyncMethod != eLSM_None)
	{
...
void CLipSyncProvider_FacialInstance::UnpauseLipSync(IEntityAudioProxy* pProxy, const TAudioControlID nAudioTriggerId, const ELipSyncMethod lipSyncMethod)
{
	if (lipSyncMethod != eLSM_None)
	{
		LipSyncWithSound(nAudioTriggerId);
...
void CLipSyncProvider_FacialInstance::StopLipSync(IEntityAudioProxy* pProxy, const TAudioControlID nAudioTriggerId, const ELipSyncMethod lipSyncMethod)
{
	if (lipSyncMethod != eLSM_None)
	{
		LipSyncWithSound(nAudioTriggerId, true);
...
void CLipSyncProvider_FacialInstance::UpdateLipSync(IEntityAudioProxy* pProxy, const TAudioControlID nAudioTriggerId, const ELipSyncMethod lipSyncMethod)
{
}
...
void CLipSyncProvider_FacialInstance::LipSyncWithSound(const TAudioControlID nAudioTriggerId, bool bStop /*= false*/)
{
