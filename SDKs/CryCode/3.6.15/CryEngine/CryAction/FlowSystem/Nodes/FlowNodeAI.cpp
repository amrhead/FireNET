...
//////////////////////////////////////////////////////////////////////////
class CFlowNode_AIAlertnessFilter : public CFlowBaseNode<eNCT_Singleton>
{
public:
...
//////////////////////////////////////////////////////////////////////////
class CFlowNode_AIGroupBeacon : public CFlowBaseNode<eNCT_Instanced>
{
public:
...
//////////////////////////////////////////////////////////////////////////
class CFlowNode_AIEnable : public CFlowBaseNode<eNCT_Singleton>
{
public:
	enum EInputs {
		IN_ENABLE,
...
//////////////////////////////////////////////////////////////////////////
class CFlowNode_AIChangeParameter : public CFlowBaseNode<eNCT_Singleton>
{
	enum EAIParamNames
	{
...
// running fast enough
//////////////////////////////////////////////////////////////////////////
class CFlowNode_HunterShootTarget : public CFlowBaseNode<eNCT_Instanced>
{
	IAIObject* m_pTarget;
	Vec3 m_targetPos;
	Vec3 m_lastPos;
...
class CFlowNode_HunterBeamSweep : public CFlowBaseNode<eNCT_Instanced>
{
	Vec3 m_targetPos;
	float m_startTime;
	float m_duration;
...
class CFlowNode_InterestingEntity : public CFlowBaseNode<eNCT_Instanced>, public IInterestListener
{
public:
	enum EInputs
	{
	...
	void GetConfiguration( SFlowNodeConfig& config )
	{
		static const SOutputPortConfig out_config[] = {
			...
			OutputPortConfig<EntityId>("OnActorCompleteAction", _HELP("Outputs when AI Entity completes an action associated with becoming interseted. It carries the EntityId")),
			OutputPortConfig<EntityId>("OnActorAbortAction", _HELP("Outputs when an action is aborted associated with this interest target. It carries the EntityId")),
			{0}
		};
...
//////////////////////////////////////////////////////////////////////////
// Register an entity with the interest system
class CFlowNode_Interested : public CFlowBaseNode<eNCT_Singleton>
{
public:
	enum EInputs
	{
...
public:
	...
	void StartCommunication(SActivationInfo *pActInfo)
	{
		...
		if (pAIProxy)
		{
			...
			request.contextExpirity = GetPortFloat(pActInfo, EIP_ContextExpirity);
...
private:
	...
	EAIFilterType GetFilterType(uint8 filterType)
	{
		switch(filterType)
		{
		case 0:		return eAIFT_All;
		case 1:		return eAIFT_Enemies;
		case 2:		return eAIFT_Friends;
		case 3:		return eAIFT_Faction;
		default:	return eAIFT_All;
		}
	}
...
REGISTER_FLOW_NODE( "AI:AlertnessFilter",CFlowNode_AIAlertnessFilter )
//REGISTER_FLOW_NODE( "AI:AISignal",CFlowNode_AISignal )
REGISTER_FLOW_NODE( "AI:AIEnable",CFlowNode_AIEnable )
REGISTER_FLOW_NODE( "AI:AIIgnore",CFlowNode_AIIgnore )
REGISTER_FLOW_NODE( "AI:FactionReaction",CFlowNode_AIFactionReaction)
REGISTER_FLOW_NODE( "AI:SetFaction", CFlowNode_AISetFaction )

REGISTER_FLOW_NODE( "AI:Interested", CFlowNode_Interested)
REGISTER_FLOW_NODE( "AI:InterestingEntity", CFlowNode_InterestingEntity)
...
REGISTER_FLOW_NODE( "AI:AIAttTarget", CFlowNode_AIAttTarget )
...
REGISTER_FLOW_NODE( "AI:AIMergeGroups", CFlowNode_AIMergeGroups )
...
REGISTER_FLOW_NODE( "AI:ChangeParameter", CFlowNode_AIChangeParameter )
REGISTER_FLOW_NODE( "AI:AISetNavCostFactor", CFlowNode_AISetNavCostFactor )
...
REGISTER_FLOW_NODE( "AI:AIEnableShape",CFlowNode_AIEnableShape)
