...
struct SFilterVisualArtifacts
{
	static void GetConfiguration(SFlowNodeConfig& config)
	{
		...
		{            
			...
			InputPortConfig<Vec3>("clr_VisualArtifacts_ColotTint", Vec3(1.0f, 1.0f, 1.0f), 0, "Color tinting"),
	...
	static void Disable()
	{
		...
		gEnv->p3DEngine->SetPostEffectParamVec4("VisualArtifacts_ColotTint", Vec4(1.0f, 1.0f, 1.0f, 1.0f));
