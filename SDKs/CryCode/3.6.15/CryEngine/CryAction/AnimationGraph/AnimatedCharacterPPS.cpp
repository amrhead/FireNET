...
void CAnimatedCharacter::UpdateSkeletonSettings()
{
	...
	{
		m_pSkeletonPose->SetForceResetToDefault(1);
	...
	{
		m_pShadowSkeletonPose->SetForceResetToDefault(1);
...
QuatT CAnimatedCharacter::CalculateWantedEntityMovement(const QuatT& desiredAnimMovement) const
{
	...
	if (DebugVelocitiesEnabled())
	{
		...
		switch (mcmh)
		{
		case eMCM_Entity: szMcmH = "ENT"; break;
		case eMCM_ClampedEntity: szMcmH = "ENT_CL"; break;
		case eMCM_SmoothedEntity: szMcmH = "ENT_SM"; break;
		case eMCM_DecoupledCatchUp: szMcmH = "DEC"; break;
		case eMCM_Animation: szMcmH = "ANM"; break;
		case eMCM_AnimationHCollision: szMcmH = "ANM_HC"; break;
		}
		char* szMcmV = "???";
		switch (mcmv)
		{
		case eMCM_Entity: szMcmV = "ENT"; break;
		case eMCM_ClampedEntity: szMcmV = "ENT_CL"; break;
		case eMCM_SmoothedEntity: szMcmV = "ENT_SM"; break;
		case eMCM_DecoupledCatchUp: szMcmV = "DEC"; break;
		case eMCM_Animation: szMcmV = "ANM"; break;
		case eMCM_AnimationHCollision: szMcmV = "ANM_HC"; break;
		}
...
void CAnimatedCharacter::GetCurrentEntityLocation()
{
	...
	m_actualEntMovementDirHorizontal.y = (float)__fsel(-(speed2D - FLT_MIN), 0.0f, velocity.y / (speed2D + FLT_MIN));
