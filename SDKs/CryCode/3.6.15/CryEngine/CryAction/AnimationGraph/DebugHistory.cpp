...
//		float x2 = m_layoutTopLeft.x + m_layoutExtent.x;
		...
		for (int i = 0; i < m_gridLineCount; i++)
		{
			...
			ti.color[0] = m_colorGridNumber[0]; ti.color[1] = m_colorGridNumber[1]; ti.color[2] = m_colorGridNumber[2]; ti.color[3] = m_colorGridNumber[3];
	...
	if (m_colorName.a > 0.0f)
	{
		...
		ti.color[0] = m_colorName[0]; ti.color[1] = m_colorName[1]; ti.color[2] = m_colorName[2]; ti.color[3] = m_colorName[3];
