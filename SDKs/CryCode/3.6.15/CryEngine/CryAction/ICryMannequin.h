...
{
	static const int MAX_PARAMS = 35;
	...
	friend bool operator == (const SProceduralEntry& entryA, const SProceduralEntry& entryB)
	{
		...
		return (entryA.type == entryB.type)
							...
							&& (entryA.dataString2 == entryB.dataString2)
...
public:
	...
	virtual QuatT ExtractLocalAnimLocation(FragmentID fragID, TagState fragTags, uint32 scopeID, uint32 optionIdx, bool ignoreOutros = false) = 0;
