...
struct SNetObjectID
{
	static const uint16 InvalidId
#ifndef __GNUC__
		// This is a workaround for a GCC bug in combination with STLPORT (leading
		// to an undefined symbol SNetObjectID::InvalidId).  For GCC the definition
		// of InvalidId is in CryCommon/CryCommon.cpp.
		= ~uint16(0)
#endif
		;
