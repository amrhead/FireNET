...
enum EAnimParamType
{
	...
	eAnimParamType_Material_Specular		= 91,
	eAnimParamType_MaterialEmission			= 92,
	eAnimParamType_MaterialOpacity			= 93,
	eAnimParamType_MaterialGlossiness		= 94,
...
#if defined(GAME_IS_RYSE)
	// Query character attachment index of this param
	virtual uint GetSkeletonAttachmentIndex(const CAnimParamType &paramType) const { return 0; }
#endif
