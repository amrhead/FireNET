...
#define SERIALIZATION_CLASS(BaseType, Type, label) \
	const Serialization::TypeDescription Type##BaseType##_DerivedDescription(Serialization::TypeID::get<Type>(), #Type, label, sizeof(Type)); \
	Serialization::ClassFactory<BaseType>::Creator<Type> Type##BaseType##_Creator(Serialization::TypeLibrary::the().registerType(&Type##BaseType##_DerivedDescription)); \
	int dummyForType_##Type##BaseType;

#define SERIALIZATION_CLASS_NAME(BaseType, Type, name, label) \
	const Serialization::TypeDescription Type##BaseType##_DerivedDescription(Serialization::TypeID::get<Type>(), name, label, sizeof(Type)); \
	Serialization::ClassFactory<BaseType>::Creator<Type> Type##BaseType##_Creator(Serialization::TypeLibrary::the().registerType(&Type##BaseType##_DerivedDescription)); \
	int dummyForType_##Type##BaseType;
