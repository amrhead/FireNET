...
#ifdef EDITOR_PCDEBUGCODE
	virtual bool ExportHTRAndICAF(const char* szAnimationName, const char* saveDirectory)= 0;
	virtual bool ExportVGrid(const char* szAnimationName, const char* savePath)= 0;
#endif
