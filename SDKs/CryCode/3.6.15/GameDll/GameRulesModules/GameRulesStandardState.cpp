...
//-------------------------------------------------------------------------
void CGameRulesStandardState::ClientChangeStateFeedback(EGR_GameState newState)
{
	...
	case EGRS_InGame:
		{
			CAudioSignalPlayer::JustPlay("Multiplayer_Music_LeaveFrontEnd");

			// Load in the MP music XML
			CAudioSignalPlayer::JustPlay("Multiplayer_Music_LoadXML");
		}
		break;
	}
}
