...
//Master server
#include "CryMasterServer/System/Global.h"
...
int CGameStartup::Run( const char * autoStartLevelName )
{
	...
	gClientEnv->pMasterServer->Connect();
#else
...
{

};
#endif
#else
...
const char** CGameStartup::GetPakFiles() const
{
#if defined(IS_EAAS)
	static const char *pakFiles[] =
	{
		...
		"Sounds.pak",
		"Textures.pak",
		// "Videos.pak", Videos can't be played by EaaS anyway
		// Add more project-specific PAK files here, as needed
		NULL
	};
	return pakFiles;
#else
	return NULL; // This will load the default list that is specified in CrySystem
#endif
}
...
LRESULT CALLBACK CGameStartup::WndProcHndl(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	if (msg == WM_CREATE)
	{
		SetWindowText(hWnd, "The Log Simulator");
	}
