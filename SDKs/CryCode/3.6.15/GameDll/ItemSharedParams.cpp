...
static SLaserParams MakeDefaultLaserParameters()
{
	...
	laserGuiderParams.laser_geometry_tp = "_objectssdk/weapons/attachments/laser_beam/laser_beam.cgf";
...
bool CItemSharedParams::ReadParams(const XmlNodeRef& paramsNode)
{
	...
	params.item_name = reader.ReadParamValue("item_name");
	params.item_class = reader.ReadParamValue("item_class");
	params.icon_name = reader.ReadParamValue("icon_name");
	params.item_description = reader.ReadParamValue("item_description");
	reader.ReadParamValue<bool>("can_stack", params.can_stack);
	reader.ReadParamValue<bool>("can_quick", params.can_quick);
	//
