...
#define GAME_NAME				"TheLogSimulator"
#define GAME_LONGNAME		"The Log Simulator"
...
//by AfroStalin
class CScriptBind_NetworkBuilding; // Network building entity
class CHUDInventory; // #Inventory
//
class CWeaponSystem;
...
public:
  ...
  // ~IGameFrameworkListener
	...
	//by AfroStalin
	CScriptBind_NetworkBuilding *GetNetworkBuildingScriptBind() { return m_pScriptBindNetworkBuilding; }
	CHUDInventory *GetHUDInventory() const { return m_pHUDInventory; } //#Inventory
	//
...
protected:
  ...
  static void CmdVote(IConsoleCmdArgs* pArgs);
	...
	//by AfroStalin
	CScriptBind_NetworkBuilding* m_pScriptBindNetworkBuilding;
	CHUDInventory*	m_pHUDInventory; //#Inventory
...
private:
	...
	std::unique_ptr<CManualFrameStepManager> m_pManualFrameStep;
#endif
};
