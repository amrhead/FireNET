...
struct SParams
{
	...
	ItemString item_class; // Weapon, Eat, Resource, Other
	ItemString icon_name;
	ItemString item_description;
	bool can_stack;
	bool can_quick;
	//
...
struct SGeometryDef
{
	SGeometryDef() :	modelPath(""), pos(0.f, 0.f, 0.f), angles(0.f, 0.f, 0.f), scale(1.f), slot(eIGS_Last), useParentMaterial(false) {};
