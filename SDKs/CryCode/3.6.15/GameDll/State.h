...
struct SStateIndex
{
	...
	SStateIndex()
		: m_name( CryHash(UNDEFINED) ), m_func( 0 ), m_stateID(UNDEFINED), m_hierarchy(UNDEFINED) { DebugInit( "UNDEFINED_NEED_TO_ADD_STATE_TO_HIERARCHY_BEFORE_TRANSITIONING_TO_IT" ); }
