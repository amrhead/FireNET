...
#include "IAIActor.h" // for IAIObject, IAIActor, IAIPathAgent

#include "GameUtils.h" // for AngleDifference
#include "TypeInfo_impl.h" // for ARRAY_COUNT
#include "GameCVars.h"
...
namespace MovementTransitionsUtil
{
	...
	const int NUM_PSEUDOSPEEDS = ARRAY_COUNT(s_pseudoSpeeds);
	...
	const int NUM_TRANSITIONTYPES = ARRAY_COUNT(s_transitionTypes);
}
