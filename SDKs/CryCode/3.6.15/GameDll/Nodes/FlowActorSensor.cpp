...
public:
	...
	void Enable()
	{
		...
		observerParams.primaryFoVCos = fovCos;
		observerParams.peripheralFoVCos = fovCos;
		...
		observerParams.eyePos = pObserverEntity->GetWorldPos();
		observerParams.eyeDir = pObserverEntity->GetForwardDir().GetNormalized();
	...
	virtual void OnEntityEvent( IEntity *pEntity, SEntityEvent &event )
	{
		if (m_enabled && event.event==ENTITY_EVENT_XFORM)
		{
			...
			{
				ObserverParams observerParams;
				observerParams.eyePos = pEntity->GetWorldPos();
				observerParams.eyeDir = pEntity->GetForwardDir().GetNormalized();
