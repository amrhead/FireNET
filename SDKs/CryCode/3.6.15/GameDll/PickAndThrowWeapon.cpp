...
class CProceduralClipAttachPnT : public TProceduralClip<SProceduralParams>
{
public:
	...
	CRYINTERFACE_BEGIN()
		...
		CRYGENERATE_CLASS(CProceduralClipAttachPnT, "AttachPnT", 0x17E197AA161E4FAA, 0xAA53E898A38EB0AF)
		...
		virtual void OnEnter(float blendTime, float duration, const SProceduralParams &params)
	{
		...
		if (!pActor)
		{
			...
			IAttachment *pAttachment = m_pAttachment = pCharacter->GetIAttachmentManager()->GetInterfaceByName(params.dataString.c_str());
...
CProceduralClipAttachPnT::CProceduralClipAttachPnT()
	: 
m_pAttachment(NULL)
{
}
...
CRYREGISTER_CLASS(CProceduralClipAttachPnT)
...
void CPickAndThrowWeapon::ThrowObject()
{
	...
	if (pOwnerPlayer != NULL)
	{
		...
		if (pPlayerAI)
		{
			...
			observableParams.pos[0] = pEntity->GetWorldPos();
