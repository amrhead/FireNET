	...
	CDownloadableResourcePtr		inResource)
{
	...
	CAntiCheatManager* pAntiCheatManager = (CAntiCheatManager*)g_pGame->GetAntiCheatManager();
	if (pAntiCheatManager)
	{
		pAntiCheatManager->SetEnableLogUploads((m_submitPermissions&k_submitAntiCheatLogs)!=0);
	}
#endif
...
void CTelemetryCopierThread::Run()
{
#ifndef _RELEASE
	m_runTime=gEnv->pTimer->GetAsyncCurTime();
#endif
	SetName("TelemetryCopier");
