...
class CFlowNodeEntityMaterial : public CFlowBaseNode<eNCT_Singleton>
{
public:
	...
	virtual void GetConfiguration( SFlowNodeConfig& config )
	{
		...
		{
			OutputPortConfig<string>( "Value",_HELP("returns the name of the material") ),
			{0}
		};
...
class CFlowNodeEntityMaterialShaderParams : public CFlowBaseNode<eNCT_Singleton>
{
public:
