...
public:
	...
	//!		<param name="sText">Text to be logged.
	...
	//!		<param name="nParam">1 to show the console, 0 to hide.
	...
	//!		<param name="entityId">Entity identifier.
	...
	//!		<param name="center">Center position vector for the area where to get entities.
	//!		<param name="radius">Radius of the area.
	...
	//!		<param name="EntityClass">Entity class name.
	...
	//!		<param name="centre">Centre position vector for the sphere where to look at entities.
	//!		<param name="radius">Radius of the sphere.
	...
	//!		<param name="centre">Centre position vector for the area where to look at entities.
	//!		<param name="radius">Radius of the sphere.
	...
	//!		<param name="centre">Centre position vector for the area where to look at entities.
	//!		<param name="radius">Radius of the sphere.
	//!		<param name="className">Entity class name.
	...
	//! </description>
	//!		<param name="sEntityName">Name of the entity to search.
	...
	//!		<param name="fSize">Size for the label.
	//!		<param name="text">Text of the label.
	//!		<param name="r">Red component for the label colour. Default is 1.
	//!		<param name="g">Green component for the label colour. Default is 1.
	//!		<param name="b">Blue component for the label colour. Default is 1.
	//!		<param name="alpha">Alpha component for the label colour. Default is 1.
	...
	//!		<param name="pos">Position of the force.
	//!		<param name="force">Strength of the force.
	//!		<param name="radius">Area where the force has effects.
	...
	//!		<param name="nMode">.
	//!		<param name="vtx">.
	//!		<param name="r">Red component for the label color. Default is 1.
	//!		<param name="g">Green component for the label color. Default is 1.
	//!		<param name="b">Blue component for the label color. Default is 1.
	//!		<param name="alpha">Alpha component for the label color. Default is 1.
	...
	//!		<param name="p1">Start position of the line.
	//!		<param name="p2">End position of the line.
	//!		<param name="r">Red component for the label color. Default is 1.
	//!		<param name="g">Green component for the label color. Default is 1.
	//!		<param name="b">Blue component for the label color. Default is 1.
	//!		<param name="alpha">Alpha component for the label color. Default is 1.
	...
	//!		<param name="p1x">X value of the start point of the line.
	//!		<param name="p1y">Y value of the start point of the line.
	//!		<param name="p2x">X value of the end point of the line.
	//!		<param name="p2y">Y value of the end point of the line.
	//!		<param name="r">Red component for the label color. Default is 1.
	//!		<param name="g">Green component for the label color. Default is 1.
	//!		<param name="b">Blue component for the label color. Default is 1.
	//!		<param name="alpha">Alpha component for the label color. Default is 1.
	...
	//!		<param name="x">X position for the text.
	//!		<param name="y">Y position for the text.
	//!		<param name="text">Text to be displayed.
	//!		<param name="font">Font name.
	//!		<param name="size">Text size.
	//!		<param name="r">Red component for the label color. Default is 1.
	//!		<param name="g">Green component for the label color. Default is 1.
	//!		<param name="b">Blue component for the label color. Default is 1.
	//!		<param name="alpha">Alpha component for the label color. Default is 1.
	...
	//!		<param name="pszEffectParam">Parameter for the post processing effect.
	//!		<param name="value">Value for the parameter.
	...
	//!		<param name="sCVarName">Name of the variable.
	...
	//!		<param name="sCCommandName">C command name.
	//!		<param name="sCommand">Command string.
	//!		<param name="sHelp">Help for the command usage.
	...
	//!		<param name="w">Width size.
	//!		<param name="h">Height size.
	...
	//!		<param name="sysMemLimitInMB">Limit of the system memory in MB.
	//!		<param name="videoMemLimitInMB">Limit of the video memory in MB.
	//!		<param name="frameTimeLimitInMS">Limit in the frame time in MS.
	//!		<param name="soundChannelsPlayingLimit">Limit of the sound channels playing.
	//!		<param name="soundMemLimitInMB">Limit of the sound memory in MB.
	//!		<param name="numDrawCallsLimit">Limit of the draw calls.
	...
	//!		<param name="gobalDensityModifier">Modifier for the global density.
	//!		<param name="atmosphereHeightModifier">Modifier for the atmosphere height.
	...
	//!		<param name="vWind">Wind direction.
	...
	//!		<param name="surfaceName">Surface name.
	...
	//!		<param name="surfaceId">Surface identifier.
	...
	//!		<param name="params">Entity parameters.
	...
	//!		<param name="bOcean">True to activate the ocean rendering, false to deactivate it.
	...
	//!		<param name="pszFolderName">Folder name.
	...
	//!		<param name="fViewDist">View distance.
	...
	//!		<param name="v3Color">Outdoor ambient color value.
	...
	//!		<param name="v3Pos">Position of the terraint to be checked.
	...
	//!		<param name="vPos">Position vector.
	//!		<param name="bActivate">True to activate the portal, false to deactivate.
	//!		<param name="nID">Entity identifier.
	...
	//!		<param name="pszName">Texture image.
	//!		<param name="bRemoveCurrent">True to remove the current image, false otherwise.
	...
	//!		<param name="vec">Position vector.
	...
	//!		<param name="bUseKB">True to use KB, false otherwise.
	...
	//!		<param name="pszParam">Parameters.
	...
	//!		<param name="fInNSeconds">Number of seconds before quitting.
	...
	//!		<param name="vPos">Position vector.
	//!		<param name="vDir">Direction vector.
	//!		<param name="nMaxHits">Maximum number of hits.
	//!		<param name="iEntTypes">.
	...
	//! <description>Gets hte HDR dynamic multiplier.</description>
	int GetHDRDynamicMultiplier(IFunctionHandler *pH);

	//! <code>System.SetHDRDynamicMultiplier( fMul )</code>
	//!		<param name="fMul">Dynamic multiplier value.
	...
	//!		<param name="vColor">Sun Color as an {x,y,z} vector (x=r,y=g,z=b).
	...
	//! <description>Set color of the sky (outdoors ambient color).
	//!		<param name="vColor">Sky Color as an {x,y,z} vector (x=r,y=g,z=b).
