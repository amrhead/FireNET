...
struct CONTROLLER_CHUNK_DESC_0828 { enum { VERSION = 0x0828 }; };
...
// unused formats (were supposed to use wavelet compression)
struct CONTROLLER_CHUNK_DESC_0830 { enum { VERSION = 0x830 }; };
struct CONTROLLER_CHUNK_DESC_0831 { enum { VERSION = 0x831 }; };
