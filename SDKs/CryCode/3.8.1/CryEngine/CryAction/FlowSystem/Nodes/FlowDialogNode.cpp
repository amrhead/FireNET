...
protected:
	...
	bool PlayDialog(SActivationInfo* pActInfo)
	{
		...
		{
		case 0: alertnessInterruptMode = CDialogSession::Alert; break;
		case 1: alertnessInterruptMode = CDialogSession::Combat; break;
		case 2: alertnessInterruptMode = CDialogSession::None; break;
