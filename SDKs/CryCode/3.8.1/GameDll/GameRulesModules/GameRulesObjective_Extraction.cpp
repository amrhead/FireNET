...
{
	m_spawnAtEntityClass = NULL;
	m_extractAtEntityClass = NULL;
	m_fallbackGunEntityClass = NULL;

	m_droppedRemoveTime = 0;
	m_defensiveKillRadiusSqr = 0.f;
	m_defendingDroppedRadiusSqr = 0.f;
	m_defendingDroppedTimeToScore = 0.f;
