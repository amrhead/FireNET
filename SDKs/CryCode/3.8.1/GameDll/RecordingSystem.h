...
public:
	...
	// IParticleEffectListener
	virtual void OnCreateEmitter(IParticleEmitter* pEmitter, QuatTS const& qLoc, const IParticleEffect* pEffect, uint32 uEmitterFlags);
	...
	virtual void OnSetSubObjHideMask(IEntity *pEntity, int nSlot, uint64 nSubObjHideMask);
	//~IBreakEventListener
...
#define REPLAY_EVENT_GUARD CRecordingSystem::SStackGuard __ReplayEventGuard__(CRecordingSystem::m_replayEventGuard);
	...
	boost::shared_ptr<ITimer> m_replayTimer;
